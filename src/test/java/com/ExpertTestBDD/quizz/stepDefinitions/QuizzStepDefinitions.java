...
public void i_click_on_all_element_to_verify_them() throws NullPointerException, IOException {
	List<UserAccountDTO> list=readFiles.readThemeData("src/test/ressources/DATA.xlsx",1);
	 int i = list.size() ;
...
public void i_click_on_each_element_of_the_Tab() throws Throwable {
	...
	List<UserAccountDTO> list=readFiles.readThemeData("src/test/ressources/DATA.xlsx",0);
	 int i = list.size() ;
	System.out.println(i);
